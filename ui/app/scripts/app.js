...
var app = angular.module('app', [
    ...
    .config(
    ['$stateProvider', '$urlRouterProvider', '$controllerProvider', '$compileProvider', '$filterProvider', '$provide', 'configuration', 'RestangularProvider',
        function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, configuration, RestangularProvider) {
            RestangularProvider.setBaseUrl(configuration.appServerUrl);
